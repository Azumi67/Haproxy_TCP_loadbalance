...
def main_menu():
    try:
        while True:
            ...
            print("2. \033[93mHaproxy loadbalance |  \033[92mTunnel   \033[93m| \033[96mRun on IRAN\033[0m")
            print("3. \033[97mHaproxy Loadbalance \033[93m| \033[92mNo Tunnel \033[93m| \033[96mRun on Kharej\033[0m")
            print("4. \033[93mStop | Start | Restart Service\033[0m")
...
def Native_menu():
    ...
    print("\033[93m|\033[0m  If you don't have native ipv6, please use private ip instead.                                             \033[0m")
    print("\033[93m'-------------------------------------------------------------------------------------------------------'\033[0m")
    ...
    try:
        ...
        display_notification("\033[93mAdding cron job for the server...\033[0m")
...
def haproxy_menu():
    ...
    print("\033[92m ^ ^\033[0m")
    print("\033[92m(\033[91mO,O\033[92m)\033[0m")
    print("\033[92m(   ) \033[93mHaproxy Loadbalance & Tunnel Menu\033[0m")
    print("\033[92m \"-\"\033[93m════════════════════════════════════\033[0m")
    display_logo2()
    print("\033[93m.-------------------------------------------------------------------------------------------------------.\033[0m")
