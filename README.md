...
**لود بالانس در سرور ایران با native ipv6**
...
**لود بالانس در سرور خارج با native ipv6**
...
**لود بالانس در سرور ایران با پرایوت ایپی**
...
<p align="right">
 ...
 <div dir="rtl">&bull; ایپی 4 سرور ایران و خارج را وارد می کنید</div>
 <div dir="rtl">&bull; پورت کانفیگ های خارج را میدهید. به طور مثال من در کانفیگ vmess با پورت های 8080 و 8081 ساخته بودم و به ازای هر ایپی 6 پرایوت ، پورت جداگانه وارد کرده ام </div>
